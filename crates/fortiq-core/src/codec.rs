...
impl DecoderLimits {
    /// Default strict limits for event and signed object records.
    ...
    /// Limits for ticket records and signed objects.
    pub const RECORD: Self = Self {
        max_input_bytes: 1024 * 1024, // 1 MiB
        max_depth: 16,
        max_container_len: 4096,
        max_bytes_len: 256 * 1024,
    };

    /// Limits for large file and attachment manifests.
    pub const MANIFEST: Self = Self {
        max_input_bytes: 2 * 1024 * 1024, // 2 MiB
        max_depth: 16,
        max_container_len: 16384,
        max_bytes_len: 512 * 1024,
    };
}
